...
import { UNKNOWN_ERROR_OCCURRED, RINGCENTRAL_NOT_AUTHENTICATED_ERROR } from '@/lib/constants';
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const response = await fetch(`${RINGCENTRAL_SERVER}${API_ENDPOINTS.EXTENSION_INFO}`, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
