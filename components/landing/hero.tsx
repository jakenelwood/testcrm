          ...
          <div className="flex flex-col md:flex-row gap-16 items-center">
            ...
            >
              <div className="mb-8">
                ...
                >
                  Meet {brand.name} — your AI-powered force multiplier. This isn't just a CRM.
                  {brand.name} gives you full marketing automation and a team of AI agents that handle
            ...
            >
              ...
              <div className="relative bg-white rounded-2xl shadow-2xl overflow-hidden border border-gray-100">
                <div className="absolute top-0 left-0 right-0 h-12 bg-gray-50 border-b border-gray-100 flex items-center px-4">
                  ...
                  <div className="mx-auto text-sm text-gray-500">{brand.dashboardTitle}</div>
                </div>
