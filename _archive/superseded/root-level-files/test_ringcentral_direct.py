...
def create_test_data():
    ...
    to_number = "+16127996380"  # Using the provided phone number
    print(f"Using phone number: {to_number}")
...
if __name__ == "__main__":
    print("RingCentral Direct Test Script")
    print("=============================")
