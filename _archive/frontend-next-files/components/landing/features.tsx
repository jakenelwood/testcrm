...
// Helper function to render text with bold Ronrico
const renderWithBoldGonzigo = (text: string) => {
  if (!text.includes('**Ronrico**') && !text.includes('**Gonzigo**')) return text;

  // Handle both old and new format for backward compatibility
  const parts = text.includes('**Ronrico**')
    ? text.split('**Ronrico**')
    : text.split('**Gonzigo**');

  return (
    <>
      {parts[0]}<span className="font-bold">Ronrico</span>{parts[1]}
    </>
  );
};
  ...
  const features = [
    {
      ...
      description: "Already sent. Soft touch. Big win. **Ronrico** automatically follows up with leads at the perfect time.",
      icon: "🔄",
    ...
    },
    {
      ...
      description: "They opened it twice. Want to nudge again? **Ronrico**'s AI suggests the next best action based on real behavior.",
      icon: "🤖",
      ...
      >
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
            ...
            <span className="font-bold">ronrico</span> listens, remembers, and nudges—all without making you pay enterprise prices to keep up.
          </p>
        </div>
              ...
              <div className="relative">
                ...
                <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100 relative">
                  <div className="absolute top-0 left-0 right-0 h-12 bg-gray-50 border-b border-gray-100 flex items-center px-4">
                    ...
                    <div className="mx-auto text-sm text-gray-500"><span className="font-bold">ronrico</span> pipeline view</div>
                  </div>
        ...
        <div className="mb-32">
          <div className="flex flex-col md:flex-row gap-16 items-center">
            <div className="flex-1">
              ...
              <p className="text-xl text-gray-600 mb-6 leading-relaxed">
                They opened it twice. Want to nudge again? <span className="font-bold">ronrico</span>'s AI suggests the next best action based on real behavior.
              </p>
              <ul className="space-y-4">
                {[
              ...
              <div className="relative">
                ...
                <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
                  <div className="absolute top-0 left-0 right-0 h-12 bg-gray-50 border-b border-gray-100 flex items-center px-4">
                    ...
                    <div className="mx-auto text-sm text-gray-500"><span className="font-bold">ronrico</span> ai assistant</div>
                  </div>
                  <div className="pt-16 pb-6 px-6">
                    <div className="bg-blue-50 rounded-lg p-4 mb-4 border border-blue-100 relative overflow-hidden">
                      <div className="text-sm text-blue-800 font-medium flex items-center">
                        <span className="font-bold">ronrico</span> says:
