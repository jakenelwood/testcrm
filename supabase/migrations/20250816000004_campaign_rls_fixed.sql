-- =============================================================================
-- CAMPAIGN SYSTEM RLS POLICIES (FIXED FOR UNIFIED SCHEMA)
-- =============================================================================
-- This script fixes the RLS policies to work with the unified schema where
-- users have a direct workspace_id reference instead of user_workspaces table
-- =============================================================================

-- Drop existing policies if they exist
DROP POLICY IF EXISTS "Users can view campaigns in their workspace" ON campaigns;
DROP POLICY IF EXISTS "Users can create campaigns in their workspace" ON campaigns;
DROP POLICY IF EXISTS "Users can update campaigns in their workspace" ON campaigns;
DROP POLICY IF EXISTS "Users can delete campaigns in their workspace" ON campaigns;

DROP POLICY IF EXISTS "Users can view ab_tests in their workspace" ON ab_tests;
DROP POLICY IF EXISTS "Users can create ab_tests in their workspace" ON ab_tests;
DROP POLICY IF EXISTS "Users can update ab_tests in their workspace" ON ab_tests;
DROP POLICY IF EXISTS "Users can delete ab_tests in their workspace" ON ab_tests;

DROP POLICY IF EXISTS "Users can view campaign_participants in their workspace" ON campaign_participants;
DROP POLICY IF EXISTS "Users can create campaign_participants in their workspace" ON campaign_participants;
DROP POLICY IF EXISTS "Users can update campaign_participants in their workspace" ON campaign_participants;

DROP POLICY IF EXISTS "Users can view campaign_transitions in their workspace" ON campaign_transitions;
DROP POLICY IF EXISTS "Users can create campaign_transitions in their workspace" ON campaign_transitions;

DROP POLICY IF EXISTS "Users can view reengagement_schedule in their workspace" ON reengagement_schedule;
DROP POLICY IF EXISTS "Users can create reengagement_schedule in their workspace" ON reengagement_schedule;
DROP POLICY IF EXISTS "Users can update reengagement_schedule in their workspace" ON reengagement_schedule;

DROP POLICY IF EXISTS "Users can view campaign_metrics in their workspace" ON campaign_metrics;
DROP POLICY IF EXISTS "Users can create campaign_metrics in their workspace" ON campaign_metrics;
DROP POLICY IF EXISTS "Users can update campaign_metrics in their workspace" ON campaign_metrics;

-- =============================================================================
-- FIXED RLS POLICIES USING DIRECT WORKSPACE_ID REFERENCE
-- =============================================================================
