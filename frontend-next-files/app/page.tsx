        ...
        <nav className="container mx-auto py-4 flex justify-between items-center">
          <div className="flex items-center gap-12">
            ...
            <div className="hidden md:flex items-center gap-8">
              <div className="flex items-center gap-1 text-gray-600 hover:text-[#8A00C4] cursor-pointer transition-colors">
                <span>Features</span>
                <ChevronDown size={16} />
              </div>
              <div className="flex items-center gap-1 text-gray-600 hover:text-[#8A00C4] cursor-pointer transition-colors">
              ...
              <Link href="/pricing" className="text-gray-600 hover:text-[#8A00C4] transition-colors">
                Pricing
              </Link>
              <div className="flex items-center gap-1 text-gray-600 hover:text-[#8A00C4] cursor-pointer transition-colors">
                <span>Resources</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-12">
            <div className="md:col-span-2">
              ...
              <div className="flex gap-4">
                <a href="#" className="w-10 h-10 rounded-full bg-gray-200 flex items-center justify-center text-gray-600 hover:bg-[#8A00C4] hover:text-white transition-colors">
