          ...
          <div className="flex flex-col md:flex-row gap-16 items-center">
            ...
            >
              <div className="mb-8">
                ...
                >
                  <Badge className="mb-6 bg-[#FD480720] text-[#FD4807] hover:bg-[#FD480730] px-3 py-1 text-sm rounded-full font-medium">
                    New
                  </Badge>
                ...
                >
                  Make the <br />
                  <span className="text-[#FD4807] font-bold">jump to better</span> <br />
                  sales pipelines
                </motion.h1>
            ...
            >
                ...
                <div className="pt-12 pb-4 px-4">
                  <div className="bg-blue-50 rounded-lg p-4 mb-4 border border-blue-100 relative overflow-hidden">
                    <div className="text-sm text-blue-800 font-medium flex items-center">
                      gonzigo says:
                      <span className="ml-1 w-2 h-2 bg-[#FD4807] rounded-full animate-pulse"></span>
                    </div>
              ...
              {/* Decorative elements */}
              <div className="absolute -bottom-6 -right-6 w-24 h-24 bg-[#FD480730] rounded-full blur-2xl"></div>
